...
class OnlineDACallbackRandPars(pl.Callback):
...
class OnlineDACallbackRandGen(pl.Callback):

    def __init__(self, generators):
        super().__init__()

        self.generators = copy.deepcopy(generators)
        self.state = {'batches': 0}
    ...
    def on_train_batch_start(self, trainer, pl_module, batch, batch_idx):
        ...
        ts_gen = np.random.choice(self.generators)
